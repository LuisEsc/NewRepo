...
CookieTool.Config = (function() {
	var config = {
		'position': 'top',
		'message': 'Floristería Albahaca utiliza cookies propias y de terceros para mejorar su experiencia de navegación, realizar tareas de analítica y mostrar publicidad acorde a sus intereses. Si continúa navegando, entendemos que acepta nuestra política de cookies. <a href="{{link}}" target="_blank">Más información</a>.<br>¿Acepta las cookies?',
		'link': 'http://www.floristeriaalbahaca.es/politica-de-cookies.html',
		'agreetext': 'Sí',
		'declinetext': 'No'
	}
