...
var Grid = (function() {
    ...
    function initEvents() {
        ...
        // when clicking an item, show the preview with the itemВґs info and large image.
    ...
    Preview.prototype = {
        ...
        update: function($item) {
            ...
            // update previewВґs content
            var $itemEl = this.$item.children('a'),
                    eldata = {
                href: $itemEl.attr('href'),
                addtohref: $itemEl.data('addtohref'),
                onclick: $itemEl.data('onclick'),
                largesrc: $itemEl.data('largesrc'),
                title: $itemEl.data('title'),
                description: $itemEl.data('description'),
                price: $itemEl.data('price'),
                currency: $itemEl.data('currency'),
                more: $itemEl.data('more'),
                or: $itemEl.data('or'),
                addtocart: $itemEl.data('addtocart')

            };

            this.$title.html(eldata.title);
            this.$description.html(eldata.description);
            this.$more.html(eldata.more);
            this.$href.attr('href', eldata.href);
            this.$addtohref.attr('href', eldata.addtohref);
            this.$onClick.attr('onclick', eldata.onclick);

            this.$price.html(eldata.price);
            this.$currency.html(eldata.currency);
            this.$or.html(eldata.or);
            this.$addtocart.html(eldata.addtocart);
            ...
            // for smaller screens we donВґt display the large image (the media query will hide the fullimage wrapper)
